...
const CreatePin = ({ user }) => {
  ...
  const uploadImage = (e) => {
    ...
    if (type === 'image/png' || type === 'image/jpeg' || type === 'image/svg' || type === 'image/gif' || type === 'image/tif') {
    ...
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5 '>
      ...
      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
            ...
            {!imageAsset ? (
              <label>
                <div className='flex flex-col items-center justify-center h-full '>
                  ...
                  <p className='mt-32 text-gray-400'>Use HQ JPEG, SVG, PNG, GIF or TIF less than 20MB</p>
                </div>
                <input
                  type='file'
                  name='upload-image'
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
            ...
            />
            {user && (
              <div className='flex gap-2 my-2 items-center bg-white rounded-full'>
                <img
                  src={user.image}
